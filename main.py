...
# 🔹 Wiskunde Feiten (✅ ULTIEME VARIATIE, STRAATTAAL & LEREN!)
WISKUNDE_FEITEN = [
    ...
    "📊 **Exponenten gaan SNEL** – Als een bacterie zich elke minuut **verdubbelt**, heb je in no-time een wereldprobleem. Zo werkt exponentiële groei. TikTok-algoritmes? Zelfde principe, maar dan met views. 📈",
