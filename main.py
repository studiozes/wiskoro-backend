...
# 🔹 Wiskunde Feiten - **Compact, helder en humoristisch!**
WISKUNDE_FEITEN = [
    "📐 Pythagoras was basically de eerste lifehacker. a² + b² = c² voorkomt dat je ooit een scheve ladder zet. 🚀",
    "🤯 Pi is oneindig! NASA gebruikt ‘t voor planeten, jij voor cirkels. Prioriteiten. 🎯",
